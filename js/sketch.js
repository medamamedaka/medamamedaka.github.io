...
fill(0);
 ...
 ellipse(700,350,70,70);
 
 fill(70,149,232);
 
 ellipse(500,400,120,40);
 ellipse(700,400,120,40);
 noStroke();
  ellipse(500,405,130,45);
 ellipse(700,405,130,45);
...
//mouth
 ...
 line(600,405,600,470);
fill(255,255,255);
 arc(600,430,100,100,0,PI);
 line(550,430,650,430);
 strokeWeight(3);
 line(600,430,600,480);
 line(575,430,575,470);
  line(625,430,625,470);
